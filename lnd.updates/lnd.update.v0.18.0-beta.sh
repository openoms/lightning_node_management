...
# $ wget https://raw.githubusercontent.com/openoms/lightning-node-management/master/lnd.updates/lnd.update.0.18.0-beta.sh && bash lnd.update.0.18.0-beta.sh

lndVersion="0.18.0-beta"
